...
import epler from '../../../assets/gamepic/5.png'
import kep from '../../../assets/dockument/Ion.pdf'
  ...
  return(
    <>
      ...
      <div className="gamess flex items-center relative bg-no-repeat bg-scroll bg-center bg-cover lg:mb-32 md:mb-20 mb-15 h-365 md:h-460 lg:h-500">
        <div className="container">
          <div className="relative 2xl:pt-20 lg:pt-16 pt-12 md:mb-12 z-10 flex flex-col justify-center items-center text-center">
            <h1
              className="text-white font-metal uppercase font-normal lg:text-5.5xl md:text-7xl text-5xl tracking-wide mb-6 text-shadow">Ion Details</h1>
            <ul className="flex">
              <li><a href="/"
              ...
              <li><span className="text-primary uppercase text-base sm:text-lg font-bold">Ion</span></li>
            </ul>
          </div>
        </div>
      </div>
      <div className="container relative">
        <h2
          className="text-white font-bold uppercase xl:text-title lg:text-5xl md:text-4xl sm:text-3xl text-2xl xl:leading-70 lg:leading-12 leading-10">Платформа - Ion стоимость площадки 4000 р.</h2>
        <div className="content-details">
          <div className="description mt-6">
            ...
            <p className="leading-8">
             Цель программы Ion<br/> За все время работы в сетевом бизнесе мы выяснили, что каждый хочет получить желаемое быстро, а еще быстрее вернуть свои вложения...
