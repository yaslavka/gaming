      ...
      <div className="breadcrumbs flex items-center relative bg-no-repeat bg-scroll bg-center bg-cover lg:mb-32 md:mb-20 mb-15 h-365 md:h-460 lg:h-500">
        <div className="container">
          <div className="relative 2xl:pt-20 lg:pt-16 pt-12 md:mb-12 z-10 flex flex-col justify-center items-center text-center">
            <h1
              className="text-white font-metal uppercase font-normal lg:text-5.5xl md:text-7xl text-5xl tracking-wide mb-6 text-shadow">Leader</h1>
            <ul className="flex">
              <li><a href="/"
              ...
              <li><span className="text-primary uppercase text-base sm:text-lg font-bold">Наставник</span></li>
            </ul>
          </div>
        </div>
      </div>
            ...
            <div className="sm:mr-12 mr-0 text-center relative">
              {userInfo.referal.avatar
                ?<>
                  ...
                  />
                  <img src={avata} style={{position: "absolute", }} className={"av"} alt={userInfo.referal.avatar}/>
                </>:<>
          ...
          <div className="w-full lg:w-1/2">
            <div className="about_title lg:mb-6 mb-4">
              ...
              <h2
                ...
                {userInfo.referal.first_name} {userInfo.referal.last_name}
             </h2>
            </div>
            <ul className="about_desc mb-10 flex mt-4">
              <li className="mr-4 last:mr-0">Telegram:{' '}
              ...
              <li className="mr-4 last:mr-0">ВКонтакте:{' '}
                {userInfo.referal.vkontakte ? (
                  <a
                    href={`https://t.me/${userInfo.referal.vkontakte}`}
                    rel="noreferrer"
                    target="_blank"
                  >
                    {userInfo.referal.vkontakte}
              ...
              <li className="mr-4 last:mr-0">Instagram:{' '}
                {userInfo.referal.instagram ? (
                  <a
                    href={`https://t.me/${userInfo.referal.instagram}`}
                    rel="noreferrer"
                    target="_blank"
                  >
                    {userInfo.referal.instagram}
              ...
              <li className="mr-4 last:mr-0">Телефон:{' '}
                {userInfo.referal.phone ? (
                  <a
                    href={`https://t.me/${userInfo.referal.phone}`}
                    rel="noreferrer"
                    target="_blank"
                  >
                    {userInfo.referal.phone}
            ...
            <p>О Наставнике</p>
            <p>{userInfo.referal.description || 'Информация отсутствует'}</p>
          </div>
        </div>
      )}
      <br/>
